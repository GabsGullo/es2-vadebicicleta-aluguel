...
class AluguelControllerTest {
    ...
    void testRealizarAluguel() {
        ...
        // Act
        ResponseEntity<AluguelOutDTO> response = aluguelController.realizarAluguel(ciclista, tranca);
    ...
    void testRealizarDevolucao() {
        ...
        // Act
        ResponseEntity<AluguelDevolucaoDTO> response = aluguelController.realizarDevolucao(idTranca, idBicicleta);
